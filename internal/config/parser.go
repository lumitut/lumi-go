...
func NewParser() *Parser {
	...
	v.SetDefault("database.database", "lumi")
	...
	v.SetDefault("redis.poolTimeout", "4s")
	v.SetDefault("redis.idleTimeout", "5m")
	...
	v.SetDefault("observability.tracingEnabled", true)
	v.SetDefault("observability.tracingSampling", 1.0)
	v.SetDefault("observability.tracingEndpoint", "localhost:4317")
	v.SetDefault("observability.tracingInsecure", true)
